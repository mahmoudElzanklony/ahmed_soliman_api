...
// check if there is any image related to this category and save it
    ...
    public function lock()
    {
        if(request()->filled('id')){
            $subscription = mediaviews::query()->find(request('id'));
            ...
            $subscription  = mediaviews::query()->whereIn('id',request('ids'))->update(['is_locked'=>1]);
            $subscription = mediaviews::whereIn('id', request('ids'))->get();
